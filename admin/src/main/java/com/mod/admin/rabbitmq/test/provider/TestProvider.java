...
public class TestProvider{
    ...
    public void test(){
        ...
        //向DL_QUEUE 发送消息  30*1000毫秒后过期 形成死信
        rabbitTemplate.convertAndSend(RabbitMqConstant.DL_EXCHANGE, RabbitMqConstant.DL_KEY, "test-deal", messagePostProcessor, correlationData);
